...
CoD.PrivateGameLobby.RampageOptions = {}
CoD.PrivateGameLobby.RampageOptions[1] = {}
CoD.PrivateGameLobby.RampageOptions[1].id = "rampage_max_round"
CoD.PrivateGameLobby.RampageOptions[1].name = "RAMPAGE MAX ROUND"
CoD.PrivateGameLobby.RampageOptions[1].hintText = "How long the Rampage Statue should last."
CoD.PrivateGameLobby.RampageOptions[1].labels = {}
CoD.PrivateGameLobby.RampageOptions[1].labels[1] = "UNLIMITED"
CoD.PrivateGameLobby.RampageOptions[1].labels[2] = "10"
CoD.PrivateGameLobby.RampageOptions[1].labels[3] = "15"
CoD.PrivateGameLobby.RampageOptions[1].labels[4] = "20"
CoD.PrivateGameLobby.RampageOptions[1].labels[5] = "25"
CoD.PrivateGameLobby.RampageOptions[1].labels[6] = "30"
CoD.PrivateGameLobby.RampageOptions[1].labels[7] = "35"
CoD.PrivateGameLobby.RampageOptions[1].labels[8] = "40"
CoD.PrivateGameLobby.RampageOptions[1].labels[9] = "45"
CoD.PrivateGameLobby.RampageOptions[1].labels[10] = "50"
CoD.PrivateGameLobby.RampageOptions[1].labels[11] = "55"
CoD.PrivateGameLobby.RampageOptions[1].labels[12] = "60"
CoD.PrivateGameLobby.RampageOptions[1].labels[13] = "65"
CoD.PrivateGameLobby.RampageOptions[1].labels[14] = "70"
CoD.PrivateGameLobby.RampageOptions[1].values = {}
CoD.PrivateGameLobby.RampageOptions[1].values[1] = 0
CoD.PrivateGameLobby.RampageOptions[1].values[2] = 10
CoD.PrivateGameLobby.RampageOptions[1].values[3] = 15
CoD.PrivateGameLobby.RampageOptions[1].values[4] = 20
CoD.PrivateGameLobby.RampageOptions[1].values[5] = 25
CoD.PrivateGameLobby.RampageOptions[1].values[6] = 30
CoD.PrivateGameLobby.RampageOptions[1].values[7] = 35
CoD.PrivateGameLobby.RampageOptions[1].values[8] = 40
CoD.PrivateGameLobby.RampageOptions[1].values[9] = 45
CoD.PrivateGameLobby.RampageOptions[1].values[10] = 50
CoD.PrivateGameLobby.RampageOptions[1].values[11] = 55
CoD.PrivateGameLobby.RampageOptions[1].values[12] = 60
CoD.PrivateGameLobby.RampageOptions[1].values[13] = 65
CoD.PrivateGameLobby.RampageOptions[1].values[14] = 70
CoD.PrivateGameLobby.RampageOptions[1].maps = {}
CoD.PrivateGameLobby.RampageOptions[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.RampageOptions[1].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.RampageOptions[1].maps[3] = "zm_buried"
CoD.PrivateGameLobby.RampageOptions[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.RampageOptions[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.RampageOptions[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.RampageOptions[1].gameTypes = {}
CoD.PrivateGameLobby.RampageOptions[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.RampageOptions[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.RampageOptions[2] = {}
CoD.PrivateGameLobby.RampageOptions[2].id = "enable_deadlight_vox"
CoD.PrivateGameLobby.RampageOptions[2].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.RampageOptions[2].hintText = "Choose to toggle mod specific subtitles and/or audio."
CoD.PrivateGameLobby.RampageOptions[2].labels = {}
CoD.PrivateGameLobby.RampageOptions[2].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.RampageOptions[2].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.RampageOptions[2].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.RampageOptions[2].labels[4] = "DISABLED"
CoD.PrivateGameLobby.RampageOptions[2].values = {}
CoD.PrivateGameLobby.RampageOptions[2].values[1] = 1
CoD.PrivateGameLobby.RampageOptions[2].values[2] = 2
CoD.PrivateGameLobby.RampageOptions[2].values[3] = 3
CoD.PrivateGameLobby.RampageOptions[2].values[4] = 0
CoD.PrivateGameLobby.RampageOptions[2].maps = {}
CoD.PrivateGameLobby.RampageOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.RampageOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.RampageOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.RampageOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.RampageOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.RampageOptions[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.RampageOptions[2].gameTypes = {}
CoD.PrivateGameLobby.RampageOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.RampageOptions[2].gameTypes[2] = "zstandard"
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.RampageOptions, "dvar")
